...
COMMENT ON COLUMN public.analises.destaque_home IS
  'Incluir na faixa de destaques secundários da home.';
...
CREATE INDEX IF NOT EXISTS analises_destaque_home_idx
  ON public.analises (destaque_home, prioridade DESC, created_at DESC)
  WHERE status = 'publicado' AND destaque_home = true;
