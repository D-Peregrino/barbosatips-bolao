...
export function HomeQuickPicksRail({ picks, viewerCanViewPremium }: Props) {
  ...
  return (
    <section aria-labelledby="home-rail-picks">
      ...
      <div className="relative">
        <div className="pointer-events-none absolute inset-y-0 left-0 z-[1] w-6 bg-gradient-to-r from-[#060504] to-transparent sm:w-10" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-[1] w-6 bg-gradient-to-l from-[#060504] to-transparent sm:w-10" />

        <ul className="no-scrollbar flex snap-x snap-mandatory gap-4 overflow-x-auto pb-2 pt-1">
          {picks.map((p) => {
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="flex w-[108px] shrink-0 flex-col items-end justify-between border-l border-white/5 pl-3">
                    <span
                      className={cn(
                    ...
                    <span className="font-mono text-3xl font-black tabular-nums leading-none text-gold-200 drop-shadow-[0_0_18px_rgba(201,162,39,0.22)]">
                      @{oddStr}
                    </span>
                  </div>
                </Link>
