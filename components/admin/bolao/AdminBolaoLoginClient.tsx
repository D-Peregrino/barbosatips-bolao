...
export function AdminBolaoLoginClient() {
  ...
  const avisoConfig =
    erroUrl === "config"
      ? "Servidor sem ADMIN_BOLAO_PASSWORD ou segredo de sessão."
      : null;
    ...
    <div className="min-h-screen bg-[#050608] text-white">
      ...
      <main className="relative mx-auto max-w-md px-4 py-12 sm:px-6 sm:py-16">
        ...
        <p className="mt-2 text-sm leading-relaxed text-zinc-400">
          Painel do bolão Copa 2026. Autenticação local por senha (variável{" "}
          <code className="text-[#C9A227]/90">ADMIN_BOLAO_PASSWORD</code>).
        </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#3d3420]/90 bg-[#050608] px-4 py-3 text-sm text-white outline-none ring-0 transition placeholder:text-zinc-600 focus:border-[#C9A227]/60"
                placeholder="••••••••"
                disabled={pending}
              />
            </div>
